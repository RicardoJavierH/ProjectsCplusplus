...
int main (void)
{
    /* Matrix data. */
    MY_TYPE n = 8;
    MY_TYPE ia[9] = { 1, 5, 8, 10, 12, 15, 17, 18, 19};
    MY_TYPE ja[18] =
    { 1,    3,       6, 7,
         2, 3,    5,
            3,             8,
    ...
    MY_TYPE mtype = -2;       /* Real symmetric matrix */
    /* RHS and solution vectors. */
    double b[8], x[8];
    MY_TYPE nrhs = 1;     /* Number of right hand sides. */
    ...
    MY_TYPE iparm[64];
    MY_TYPE maxfct, mnum, phase, error, msglvl;
    /* Auxiliary variables. */
    MY_TYPE i;
    double ddum;          /* Double dummy */
    MY_TYPE idum;         /* Integer dummy. */
/* -------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------- */
    ...
    iparm[19] = 0;
    //iparm[34]=1;/* Output: Numbers of CG Iterations */
...
/* -------------------------------------------------------------------- */
    ...
    if ( error != 0 )
    {
        printf ("\nERROR during numerical factorization: %d", (int)error);
        exit (2);
    }
...
/* -------------------------------------------------------------------- */
    ...
    if ( error != 0 )
    {
        printf ("\nERROR during solution: %d", (int)error);
        exit (3);
    }
    printf ("\nSolve completed ... ");
